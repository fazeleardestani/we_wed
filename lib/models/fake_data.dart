...
List<CategoryModel> categoryList = [
  CategoryModel(id: 1 , imagePath: Assets.icons.talarCategory.path , title: MyStrings.talarCategory),
  CategoryModel(id: 2 , imagePath: Assets.icons.talarCategory.path , title: MyStrings.arayeshgahCategory),
  CategoryModel(id: 3 , imagePath: Assets.icons.talarCategory.path , title: MyStrings.photographyCategory),
